...
SHEET_URL = "https://docs.google.com/spreadsheets/d/1foCsja-2HRi8HHjnMP8CyheaLOwk-ZiJ7a5uqs9khvo/edit?usp=drivesdk"
SHEET_CREDS = "credentials.json"  # আপনার Google API credentials ফাইল
...
WIN_STREAK_STICKERS = [
    ...
    "CAACAgUAAxkBAAEQUC9pc4K3oMmF8_JT65VPOX2IYOPK7gACvxoAAiTSoFTCNTn7DlshyDgE",
    "CAACAgUAAxkBAAEQUCxpc4K3MvFEm16hVZOXxTRrjC_ewwAC2BkAAqXaoFTg7Jw58XyyCzgE",
    "CAACAgUAAxkBAAEQUCppc4K3WFpWpNICc3y6jsgpxvX-PAACaxoAAo8OoFSQ1MAa3WjmsTgE",
    "CAACAgUAAxkBAAEQUClpc4K33u79cTZ1b7fF6pOQaOxAAiMAAmMZAAKSVABVtJd1gR64idU4BA",
    "CAACAgUAAxkBAAEQUCJpc4K3yqShKjnjM4IAAeWqVh66UeYAAvYaAAIa4phUJYcSfGRWc-Y4BA",
    "CAACAgUAAxkBAAEQUC5pc4K4z9-ByclHioLPAAGobgZt_NsAAvwXAAJ1P7FVbYPTiKKqHgc4BA",
    "CAACAgUAAxkBAAEQUCBpc4K4AAGVt66e5J_MpZg6HDH5C7cAAnQbAAIW4KhUeG__MowrFLA4BA",
    "CAACAgUAAxkBAAEQUCBpc4K4AAGVt66e5J_MpZg6HDH5C7cAAnQbAAIW4KhUeG__MowrFLA4BA",
    "CAACAgUAAxkBAAEQUC5pc4K4z9-ByclHioLPAAGobgZt_NsAAvwXAAJ1P7FVbYPTiKKqHgc4BA",
...
def check_password_from_sheet():
    try:
        scope = ["https://spreadsheets.google.com/feeds", "https://www.googleapis.com/auth/drive"]
        creds = ServiceAccountCredentials.from_json_keyfile_name(SHEET_CREDS, scope)
        client = gspread.authorize(creds)
        sheet = client.open_by_url(SHEET_URL).sheet1
        password = sheet.acell('A1').value
        return password
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not state.session_password:
        sheet_password = check_password_from_sheet()
        if sheet_password and msg == sheet_password:
            ...
            await update.message.reply_text(
                "❌ <b>Invalid Password!</b>\nPlease contact @OWNER_MARUF_TOP",
                parse_mode=ParseMode.HTML
            )
        return
    ...
    if "Stop Session" in msg:
        state.is_running = False
        await send_session_sticker(update.message, False)
        await update.message.reply_text(
    ...
    if "Connect" in msg:
        ...
        await send_session_sticker(update.message, True)
