...
def format_result(issue: str, res_num: str, res_type: str, pick: str, is_win: bool) -> str:
    ...
    # যদি আমরা মিথ্যা উইন দেখাই, তাহলে রেজাল্ট টাইপ এবং নম্বরও ফেইক হতে হবে
    # যাতে ইউজার কনফিউজ না হয়।
    ...
    if is_win:
        ...
        # If it's a Fake Win (Real logic might differ, but here we align with Pick)
        display_type = pick 
        display_num = res_num
...
def format_summary() -> str:
    # FAKE SUMMARY STATS (Calculated from state.wins which is boosted)
